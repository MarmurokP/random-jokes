...
function setLocalStorage() {
  ...
  console.log("Отметка за задание 75 баллов/n1 Смена изображений в секции portfolio +25/n2 Перевод страницы на два языка +25/n3 Переключение светлой и тёмной темы +25
  На страницу добавлен переключатель/n4 сложные эффекты для кнопок при наведении и/или клике/n5 Сохранение в local storage выполнено только для светлой\темной темы")